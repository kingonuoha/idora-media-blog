...
<form id="addPostForm" method="POST" class="form d-flex flex-column flex-lg-row" action="{{route('create_post')}}" enctype="multipart/form-data">
    @csrf
    <!--begin::Aside column-->
    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body text-center pt-0">
                ...
                <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                    ...
                    <!--begin::Label-->
                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Add Featured Image">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <!--end::Label-->
                <!--begin::Select2-->
                <select name="post_category" class="form-select mb-2" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple">
                    <option></option>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="post_title" class="form-control mb-2" placeholder="Post Title" value="" />
                            ...
                            <div>
                                ...
                                <textarea id="post_content" name="post_content" rows="6" placeholder="Post Description" class="ckeditor form-control"></textarea>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="fv-row">
                                ...
                                <div class="form-check form-check-custom form-check-solid mb-2">
                                    <input name="sendEmail" class="form-check-input" type="checkbox" id="kt_ecommerce_add_product_shipping_checkbox" value="1" />
...
<script src="{{asset('/ckeditor/ckeditor.js')}}"></script>
    <script>
        $('form#addPostForm').on('submit', function(e){
            e.preventDefault();
            $("#submit_btn span.indicator-label").hide()
            $("#submit_btn span.indicator-progress").show()
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    $("#submit_btn span.indicator-label").show()
                    $("#submit_btn span.indicator-progress").hide()
