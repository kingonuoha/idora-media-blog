                ...
                <div class="flex-grow-1">
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$author->name}}</a>
                                <a href="#">
                            ...
                            <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                ...
                                <!--end::Svg Icon-->{{$author->occupation}}</a>
                                <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                    ...
                    <div class="d-flex flex-wrap flex-stack">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--end::Svg Icon-->
                                        <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="{{auth()->user()->posts->count()}}" data-kt-countup-prefix="- ">0</div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--end::Svg Icon-->
                                        <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="{{getTotalViewsForUser()}}">0</div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-semibold fs-6 text-gray-400">Total View Gained</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Stat-->
                            </div>
                        ...
                        @php
                            ...
                            $percent = getPercentNull($author->toArray(), ['id',"email_verified_at", "two_factor_confirmed_at", "facebook_id", "google_id", "profile_photo_url", "current_team_id", "profile_photo_updated_at", "blocked",'created_at', 'updated_at', 'role', 'email_sent_at', 'last_login', 'last_ip']);
                        @endphp 
        ...
        {{--  Admin Change PRofile Pic --}}
			<script>
				$('#changeAuthorPictureProfile').ijaboCropTool({
                    ...
                    processUrl:'{{ route("profile_change") }}',
