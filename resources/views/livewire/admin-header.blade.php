                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                                        ...
                                        <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                                            ...
                                            <a href="{{route('index')}}" class="btn btn-sm btn-primary fw-bold">Explore</a>
                                        </div>
                                        <!--end:Landing-->
                                    </div>
                                    <!--end:Col-->
                                ...
                                @foreach ($links as $key => $item)
                                     ...
                                     <div class="tab-pane {{$setFirstActive}} w-lg-600px" id="kt_app_header_menu_pages_{{$key}}">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-7">
                                                <img src="{{asset('admin/assets/media/stock/900x600/4'.$int.'.jpg')}}" class="rounded mw-100" alt="" />
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                        <!--end:Row-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" >
                    ...
                    <div  class="position-relative btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        ...
                        <div wire:poll class="position-absolute top-0 start-100 translate-middle">

                            @if ($user->unreadNotifications->count() > 0)
                            <span class="  badge badge-circle badge-primary" id="notifications" >{{$user->unreadNotifications->count()}}</span>
                            @endif
                        </div>
                        <span class="svg-icon svg-icon-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!--begin::Menu-->
                    <div wire:ignore  class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" >
                        <!--begin::Heading-->
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{asset('admin/assets/media/misc/menu-header-bg.jpg')}}')">
                            ...
                            <span class="fs-8 opacity-75 ps-3 badge circle-pill bg-light-success text-white cursor-pointer" wire:click="markAllAsRead()">Read {{$user->unreadNotifications->count()}} New report</span></h3>
                            <!--end::Title-->
                            <!--begin::Tabs-->
                            <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                <li class="nav-item">
                                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab" href="#kt_topbar_notifications_1" >Alerts <span class=" ml-1 badge badge-circle badge-primary" wire:poll>{{$user->unreadNotifications->count()}}</span></a> 
                                    {{-- wire:click="markAlertsAsRead({{$user->unreadNotifications->count()}})" --}}
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel" >
                                ...
                                <div class="scroll-y mh-325px my-5 px-8" >
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px me-4">
                                                <span class="symbol-label bg-light-{{$notification->data['type']}}">
                                                    ...
                                                    <span class="svg-icon svg-icon-2 svg-icon-{{$notification->data['type']}}">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8">{{time_Ago($notification->data['time'])}}</span>
                                        <!--end::Label-->
                                    </div>
                                    @empty
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <!--begin::Symbol-->
                                            <h5><b>No Notification for now</b></h5>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                ...
                                <div class="py-3 text-center border-top">
                                    <a href="{{route("user_notification")}}" class="btn btn-color-gray-600 btn-active-color-primary">View All 
                            ...
                            <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="pt-10 pb-0">
                                        <!--begin::Title-->
                                        <h3 class="text-dark text-center fw-bold">No Updates for now</h3>
                                        <!--end::Title-->
                                        <!--begin::Text-->
                                        ...
                                        <div class="text-center mt-5 mb-9">
                                            <a href="{{route('list_blog')}}" class="btn btn-sm btn-primary px-6">All Blog Posts</a>
                                        </div>
                                        <!--end::Action-->
                                    </div>
                                    <!--end::Section-->
                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            <!--begin::Code-->
                                            <span class="w-70px badge badge-light-{{$item->type}} me-4">{{strtoupper($item->type)}}</span>
                                            <!--end::Code-->
                                            <!--begin::Title-->
                ...
                <!--begin::Theme mode-->
                <div  wire:ignore.self class="app-navbar-item ms-1 ms-lg-3">
                    <!--begin::Menu toggle-->
                ...
                <div  class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div wire:ignore.self class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        <!--begin::Menu item-->
